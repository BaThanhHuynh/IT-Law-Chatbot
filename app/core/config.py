...
class Config:
    ...
    NEO4J_PASSWORD = os.getenv("NEO4J_PASSWORD", "21102005")
    ...
    # Embedding model
    EMBEDDING_MODEL = os.getenv("EMBEDDING_MODEL", os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "models", "law_v2_model_20260505_1418"))
    EMBEDDING_DIM = 768
